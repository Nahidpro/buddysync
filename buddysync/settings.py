"""
Django settings for buddysync project.
...
SECRET_KEY = 'django-insecure-zu78=qs(jbjs7=!45yp31!w!q^qj8gmm6z$wcw02i!-(#ba##c'
...
WSGI_APPLICATION = 'buddysync.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': os.path.join('/var/lib/sqlite', 'db.sqlite3'),
    }
}
